...
const APPS = [
  ...
  { slug: 'zrooms', name: 'Z-Rooms', description: 'Manajemen properti', icon: 'house-door', url: 'https://zxroom.zomet.my.id', color: '#0891b2', category: 'property', order: 5 },
  ...
  { slug: 'zgym', name: 'ZXgym', description: 'Manajemen fitness & gym', icon: 'heart-pulse', url: 'https://zxgym.zomet.my.id', color: '#2563eb', category: 'booking', order: 10 },
