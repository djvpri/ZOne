...
const SSO_ENABLED_SLUGS = new Set(['zface', 'zpos', 'zresto', 'zlaundry', 'zgold', 'zbengkel', 'zmedics', 'zabsen', 'zrooms', 'z-rooms', 'zbilliar', 'zgym', 'ztrans', 'zwisata', 'zprint', 'zbarber', 'zkuis', 'zgadai'])
