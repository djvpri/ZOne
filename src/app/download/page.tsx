...
const downloads: Record<Platform, AppDownload[]> = {
  ...
  android: [
    ...
    { id: 'zshield',   name: 'ZShield',     description: 'Link protection & security device membership',       version: '0.4.0', size: '8 MB',  color: 'from-lime-500 to-green-600',   driveUrl: 'https://github.com/djvpri/zsafe_android/releases/latest/download/ZShield-v0.4.0.apk' },
  ],
  ios: [
