...
const downloads: Record<Platform, AppDownload[]> = {
  ...
  android: [
    ...
    { id: 'zsafe',     name: 'ZSafe',        description: 'Link protection & security device membership',       version: '0.1.0', size: '8 MB',  color: 'from-lime-500 to-green-600',   driveUrl: 'https://github.com/djvpri/zsafe_android/releases/latest/download/Zsafe-v0.1.0.apk' },
  ],
  ios: [
